defmodule OhMyAdolfWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(OhMyAdolfWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(OhMyAdolfWeb.Gettext, "errors", msg, opts)
    # end
